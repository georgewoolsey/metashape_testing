...
qlty_filter_draws_temp %>% 
  ...
  kableExtra::kbl(
    digits = 2
    , caption = "F-score<br>95% HDI of the posterior distribution of conditional mean group estimates"
    , col.names = c(
      "quality", "filtering"
      , "median"
      , "conf.low", "conf.high"
...
table_temp %>% 
  ...
  kableExtra::kbl(
    digits = 2
    , caption = "brms::brm model: 95% HDI of the posterior distribution of conditional means"
    , col.names = c(
      "quality", "filtering"
      , "F-score"
      , "conf.low", "conf.high"
