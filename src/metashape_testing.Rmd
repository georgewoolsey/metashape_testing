...
pdf_list_df %>% 
  ...
  labs(
    ...
    , fill = "Filtering Mode"
    , y = "Dense Cloud + Depth Map time (mins)"
    , x = "Quality"
    , title = "Processing time by depth map generation quality and filtering mode"
  ) +
  theme_light() +
  theme(
    legend.position = "top"
...
pdf_list_df %>% 
  ...
  scale_color_viridis_d(option = "plasma") +
  scale_fill_viridis_d(option = "plasma") +
  scale_y_continuous(labels = scales::comma_format(suffix = " M", scale = 1e-6, accuracy = 1)) +
  labs(
    color = "Filtering Mode"
    , fill = "Filtering Mode"
